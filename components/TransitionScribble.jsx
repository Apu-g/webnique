    ...
    useEffect(() => {
        ...
        const runScribbleAnimation = (e) => {
            ...
            drawTl.to(transitionLogo, {
                ...
                onStart: () => {
                    const logoElem = transitionLogo.querySelector('.logo-truus');
                    if (logoElem) gsap.to(logoElem, { rotation: 5, duration: 0.15, repeat: -1, yoyo: true, ease: 'steps(1)', overwrite: 'auto' });
                }
            }, durIn * 0.5);
            ...
            drawTl.set(transitionLogo, {
                ...
                onComplete: () => {
                    const logoElem = transitionLogo.querySelector('.logo-truus');
                    if (logoElem) {
                        gsap.killTweensOf(logoElem);
                        gsap.set(logoElem, { rotation: 0 });
                    }
                }
            }, durIn + (durOut * 0.48));
        };
